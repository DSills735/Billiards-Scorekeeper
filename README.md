...
The intended use of this application is for people to score straight pool. This is not a teacher, simply a scoreboard. The rules of the game need to be known prior to playing. 

An example of the rules can be found here: https://www.cuesight.com/wpa/14-1-straight-pool-rules/
